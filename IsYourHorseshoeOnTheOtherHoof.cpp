...
so you need to help Valera and determine what is the minimum number of horseshoes he needs to buy to wear four horseshoes 
...
int main()
{
    ...
    for(int i = 0; i < 4; i++){
        if(shoe[i] == shoe[i + 1] || shoe[i] == shoe[i + 2] || shoe[i] == shoe[i + 3]){
            diff++;
        }
    }
