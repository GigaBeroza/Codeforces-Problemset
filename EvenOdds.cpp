...
int main(){
    long long numbers, point, out, half;

    cin>>numbers>>point;

    if (numbers%2==0) half=numbers/2;
    else half=(numbers+1)/2;
    if (point<=half && point>=1) out=(2*point)-1;
    if (point>half && point>=1) out=(point-half)*2;
